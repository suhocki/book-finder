...
class BackgroundPresenter @Inject constructor(
    ...
    fun loadDatabase(fileName: String, fileUrl: String) = doAsync(errorHandler.errorReceiver) {
        ...
        val bytes = interactor.downloadFile(fileUrl)
//        val zipFile = interactor.saveFile(fileName, bytes)
...
//        interactor.saveInfoData(xlsDocument.infosData)
