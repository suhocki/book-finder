...
@VisibleForTesting
class MinHeightFastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    private final int mFastScrollMinimumHeight;
    ...
    MinHeightFastScroller(RecyclerView recyclerView, StateListDrawable verticalThumbDrawable,
                          Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable,
                          Drawable horizontalTrackDrawable, int defaultWidth, int scrollbarMinimumRange,
                          int margin, int fastScrollMinimumHeight) {
        mFastScrollMinimumHeight = fastScrollMinimumHeight;
