...
public class EndActionDiffUtil {

    private EndActionDiffUtil() {
    ...
    public static class DiffResult {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback updateCallback) {
            final EndActionBatchingListUpdateCallback batchingCallback;
            if (updateCallback instanceof EndActionBatchingListUpdateCallback) {
                batchingCallback = (EndActionBatchingListUpdateCallback) updateCallback;
            } else {
                batchingCallback = new EndActionBatchingListUpdateCallback(updateCallback);
