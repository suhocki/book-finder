 ...
 */
public class EndActionBatchingListUpdateCallback implements ListUpdateCallback {
    ...
    public EndActionBatchingListUpdateCallback(ListUpdateCallback callback) {
        mWrapped = callback;
    }
    ...
    public void dispatchLastEvent() {
        if (mWrapped instanceof EndActionAdapterListUpdateCallback) {
            ((EndActionAdapterListUpdateCallback)mWrapped).onLastEvent();
        }
